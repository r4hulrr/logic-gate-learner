...
module z2 (
  ...
  wire signed [17 : 0]  douta_1, douta_2, douta_3, douta_4, douta_5, douta_6, douta_7, douta_8, douta_9, douta_10;
    ...
    if (reset) begin
      ...
      case (state)
        ...
        LOAD: begin
          ...
          accum1 <= accum1 + ((input_value * douta_1) >>> 15);
          accum2 <= accum2 + ((input_value * douta_2) >>> 15);
          accum3 <= accum3 + ((input_value * douta_3) >>> 15);
          accum4 <= accum4 + ((input_value * douta_4) >>> 15);
          accum5 <= accum5 + ((input_value * douta_5) >>> 15);
          accum6 <= accum6 + ((input_value * douta_6) >>> 15);
          accum7 <= accum7 + ((input_value * douta_7) >>> 15);
          accum8 <= accum8 + ((input_value * douta_8) >>> 15);
          accum9 <= accum9 + ((input_value * douta_9) >>> 15);
          accum10 <= accum10 + ((input_value * douta_10) >>> 15);
