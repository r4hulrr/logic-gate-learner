...
HD_PWD='C:/Users/Admin/Documents/Projects/logic-gate-learner/verilog_code/final_nn/z_1.runs/blk_mem_gen_77_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blk_mem_gen_77.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blk_mem_gen_77.tcl
