...
def load_q15_weights_and_biases():
    ...
    W1 = load("python_code/GUI/weights_and_biases/w1_q15.txt", (10, 784))
    b1 = load("python_code/GUI/weights_and_biases/b1_q15.txt", (10, 1))
    W2 = load("python_code/GUI/weights_and_biases/w2_q15.txt", (10, 10))
    b2 = load("python_code/GUI/weights_and_biases/b2_q15.txt", (10, 1))
    return W1, b1, W2, b2
